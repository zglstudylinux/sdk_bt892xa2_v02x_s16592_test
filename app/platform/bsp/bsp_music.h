...
typedef bool (*res_play_kick_func)(u32 addr, u32 len, bool kick);
typedef void (*res_play_exit_func)(void);
...
bool bsp_res_music_play(u32 addr, u32 len, res_play_kick_func res_play_kick);         //²¥·ÅRES MUSIC

...
typedef struct {
...
#if (VUSB_SMART_VBAT_HOUSE_EN || LE_POPUP_VBAT_EN)
    u8 rem_house_bat;
    u8 rem_bat;
    ...
    u8 loc_bat;
    u8 popup_en;
    bool charge_once_full;      //上一次充电是否满电过, 为了兼容在耳机满电查询功能中, 满电后会自动掉维持电压的仓
#endif
...
#if ASR_EN
    u8 asr_enable;
    volatile u8 asr_flag;
    volatile u8 sys_is_sleep;
#endif
} sys_cb_t;

 ...
 *****************************************************************************/
#ifndef SDK_VERSION
    #define SDK_VERSION             0x0200      //V020.0
#endif
...
#if (VUSB_SMART_VBAT_HOUSE_EN && VUSB_HUART_DMA_EN)||VUSB_TBOX_QTEST_EN || EQ_DBG_IN_UART || BT_SCO_DUMP_TX_EN
#undef    HUART_EN
#define   HUART_EN                    1
#endif
...
#if !(BT_SNDP_DMIC_EN || BT_SCO_BCNS_EN || BT_SCO_DMNS_EN || BT_SCO_DMDNN_EN || BT_SNDP_DMIC_DNN_EN)
#undef DMIC_DBG_EN
#define DMIC_DBG_EN                     0
#endif

#if !(BT_SCO_AINS2_EN || BT_SNDP_EN || BT_SCO_DNN_EN || BT_SCO_AINS3_EN || BT_SCO_AIAEC_DNN_EN)
#undef SMIC_DBG_EN
...
#if LE_APP_EN || GFPS_EN || LE_BQB_RF_EN || AB_MATE_APP_EN || LE_WK_APP_EN || LE_TUYA_EN || LE_QCY_APP_EN || TME_APP_EN || LE_DUEROS_DMA_EN
    #define LE_EN                   1
...
#if GFPS_EN || LE_WK_APP_EN || LE_TUYA_EN
#undef LE_ADV_POWERON_EN
#define LE_ADV_POWERON_EN          0
#endif

#if AB_MATE_APP_EN || LE_TUYA_EN
#undef SYS_EQ_FOR_IDX_EN
#undef BT_A2DP_AVRCP_PLAY_STATUS_EN

#define SYS_EQ_FOR_IDX_EN               1
...
#ifndef BT_A2DP_SUPTO_RESTORE_PLAY_EN
#define BT_A2DP_SUPTO_RESTORE_PLAY_EN   1
#endif
...
#undef BT_AVDTP_DELAY_REPORT_EN
#define BT_A2DP_AAC_AUDIO_EN        0
#define BT_AVDTP_DELAY_REPORT_EN    0
#endif

#define BT_MUSIC_AUDIO_EN   (BT_V3D_AUDIO_EN || BT_VBASS_AUDIO_EN || BT_DYNAMIC_BASS_BOOST_EN || BT_DYNAMIC_EQ_EN)
#define BT_MUSIC_AUDIO_TYPE (BT_V3D_AUDIO_EN | (BT_VBASS_AUDIO_EN << 1) | (BT_DYNAMIC_BASS_BOOST_EN << 4))

#if BT_DYNAMIC_EQ_EN && !BT_TWS_EN
#error "AUDIO_DBG: please open BT_TWS_EN if you want to open dynamic eq\n"
#endif

#if BT_DYNAMIC_BASS_BOOST_EN && BT_DYNAMIC_EQ_EN
#error "AUDIO_DBG: please choose only one selection in BT_DYNAMIC_BASS_BOOST_EN or BT_DYNAMIC_EQ_EN\n"
#endif
...
#ifndef BT_TWS_NOT_AUTO_CONNECT_EN
#define BT_TWS_NOT_AUTO_CONNECT_EN  0
#endif

#ifndef BT_HCI_DIS_ONLY_SPP_EN
#define BT_HCI_DIS_ONLY_SPP_EN  0
#endif
...
#if BT_SPP_FOT_EN || LE_APP_FOT_EN
#undef FOT_EN
...
#if BT_SPP_FOT_EN
#if !BT_SPP_EN
#error "FOTA: please open BT_SPP_FOT_EN & BT_SPP_EN at the same time\n"
#endif
#endif
...
#if (BT_SCO_NR_EN || BT_SNDP_EN || BT_SCO_ANS_EN || BT_SCO_AINS2_EN || BT_SCO_AINS3_EN || BT_SCO_DNN_EN || BT_SCO_DNN_PLUS_EN || BT_SCO_AIAEC_DNN_EN)
#undef BT_SCO_SMIC_EN
#define BT_SCO_SMIC_EN                  1
#endif

#if (BT_SNDP_DMIC_EN || BT_SCO_DMNS_EN || BT_SCO_DMDNN_EN || BT_SCO_LDMDNN_EN)
...
#if BT_AEC_EN && BT_NLMS_AEC_EN && BT_NLMS_FRE_EN
#error "AEC_DBG: please choose only one selection in BT_AEC_EN or BT_NLMS_AEC_EN or BT_NLMS_FRE_EN at the same time\n"
#endif // BT_AEC_EN

#if BT_NLMS_AEC_EN || BT_NLMS_FRE_EN
#undef BT_SNDP_MODE
#undef BT_SCO_AINS2_MODE
#undef BT_SCO_AINS3_MODE
#undef BT_SCO_DNN_MODE
#undef BT_SCO_AIAEC_DNN_MODE

#define BT_SNDP_MODE                0
#define BT_SCO_AINS2_MODE           0
#define BT_SCO_AINS3_MODE           0
#define BT_SCO_DNN_MODE             0
#define BT_SCO_AIAEC_DNN_MODE       0
#endif

#if BT_NLMS_AEC_EN && ((BT_SNDP_EN && BT_SNDP_MODE) || (BT_SCO_AINS2_EN && BT_SCO_AINS2_MODE) || (BT_SCO_AINS3_EN && BT_SCO_AINS3_MODE) || (BT_SCO_DNN_EN && BT_SCO_DNN_MODE) || (BT_SCO_AIAEC_DNN_EN && BT_SCO_AIAEC_DNN_MODE))
#error "NLMS_AEC_DBG: please set BT_SNDP_MODE or BT_SCO_AINS2_MODE or BT_SCO_AINS3_MODE or BT_SCO_DNN_MODE to 0\n"
#endif

#if (BT_SNDP_DMIC_EN || BT_SCO_DMNS_EN || BT_SCO_DMDNN_EN || BT_SCO_LDMDNN_EN || BT_SNDP_DMIC_DNN_EN) && (BT_SNDP_EN || BT_SCO_AINS2_EN || BT_SCO_DNN_EN || BT_SCO_AINS3_EN || BT_SCO_AIAEC_DNN_EN)
#error "NR_DBG: please select only one nr algorithm in BT_SNDP_DMIC_EN or BT_SNDP_EN or BT_SCO_AINS2_EN or BT_SCO_DMNS_EN or BT_SCO_DMDNN_EN or BT_SNDP_DMIC_DNN_EN or BT_SCO_AINS3_EN\n"
#endif

#if BT_SNDP_EN && BT_SCO_AINS2_EN && BT_SCO_DNN_EN && BT_SCO_AINS3_EN && BT_SCO_AIAEC_DNN_EN
#error "NR_DBG: please select only one nr algorithm in BT_SNDP_DMIC_EN or BT_SNDP_EN or BT_SCO_AINS2_EN or BT_SCO_DMNS_EN or BT_SCO_DMDNN_EN or BT_SNDP_DMIC_DNN_EN or BT_SCO_AINS3_EN\n"
#endif

#if (BT_AEC_DUMP_EN || BT_AEC_FRE_DUMP_EN) && (BT_SNDP_DUMP_EN || BT_SCO_FAR_DUMP_EN || BT_AINS2_DUMP_EN || BT_SCO_DUMP_EN)
#error "DUMP_DBG: please select only one dump in BT_AEC_DUMP_EN, BT_AEC_FRE_DUMP_EN, BT_SNDP_DUMP_EN, BT_SCO_FAR_DUMP_EN, BT_AINS2_DUMP_EN, BT_SCO_DUMP_EN\n"
#endif

#if BT_SCO_FAR_DUMP_EN && (BT_SNDP_DUMP_EN || BT_AINS2_DUMP_EN || BT_SCO_DUMP_EN)
#error "DUMP_DBG: please select only one dump in BT_AEC_DUMP_EN, BT_AEC_FRE_DUMP_EN, BT_SNDP_DUMP_EN, BT_SCO_FAR_DUMP_EN, BT_AINS2_DUMP_EN, BT_SCO_DUMP_EN\n"
#endif
...
#if BT_SCO_DUMP_EN && SMIC_DBG_EN && DMIC_DBG_EN
#error "DUMP_DBG: please select only one method in BT_SCO_DUMP_EN, SMIC_DBG_EN, DMIC_DBG_EN\n"
#endif

#if (BT_SCO_DMNS_EN || BT_SCO_DMDNN_EN || BT_SNDP_DMIC_EN || BT_SNDP_DMIC_DNN_EN) && BT_NLMS_FRE_EN && (BT_SCO_FAR_NR_EN && BT_SCO_FAR_NR_SELECT) && BT_TRUMPET_DENOISE_EN
#error "NR_DBG: unsupported mode, please check the sco algorithm!\n"
#endif

#if (BT_SNDP_DMIC_DNN_EN && BT_SNDP_DMIC_DNN_NLMS_EN && BT_SCO_FAR_NR_EN)
#error "NR_DBG: unsupported mode, please check the sco algorithm! BT_SNDP_DMIC_DNN_EN, BT_SNDP_DMIC_DNN_NLMS_EN, BT_SCO_FAR_NR_EN are opended at the same time!\n"
#endif

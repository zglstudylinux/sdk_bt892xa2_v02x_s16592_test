...
#define TUYA_BLE_APP_VERSION_STRING    TUYA_DEVICE_FVER_STR       //固件版本

#define TUYA_BLE_APP_BUILD_FIRMNAME_STRING  TUYA_DEVICE_FIR_NAME

#define TUYA_BLE_PORT_PLATFORM_HEADER_FILE  "tuya_ble_bt892x.h"

#define TUYA_BLE_APP_FIRMWARE_KEY           TUYA_DEVICE_FIR_KEY
 ...
 * gatt mtu max sizes
 */
#define TUYA_BLE_DATA_MTU_MAX  253//(256-3)
...
/* start address */
#define TUYA_NV_START_ADDR             (FLASH_SIZE - 0x5000 - EQ_TBL_RES2_EN * 0x1000 - TUYA_NV_AREA_SIZE)

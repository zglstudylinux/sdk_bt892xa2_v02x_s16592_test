...
#define BT_PROFILE          (PROF_A2DP*BT_A2DP_EN) | (PROF_HFP*BT_HFP_EN) | (PROF_SPP*BT_SPP_EN) | (PROF_HID*BT_HID_EN) | (PROF_HSP*BT_HSP_EN) | (PROF_PBAP*BT_PBAP_EN) | (PROF_GATT*BT_ATT_EN)
#define BT_CODEC            (CODEC_SBC) | (CODEC_AAC*BT_A2DP_AAC_AUDIO_EN) | (CODEC_MSBC * BT_HFP_MSBC_EN) | (CODEC_PLC * BT_PLC_EN)
#define HFP_FEATURE         (HFP_BAT_REPORT*BT_HFP_BAT_REPORT_EN) | (HFP_INBAND_RING_TONE*BT_HFP_INBAND_RING_EN) | (HFP_CALL_PRIVATE*BT_HFP_CALL_PRIVATE_FORCE_EN) | (HFP_RING_NUMBER_EN*BT_HFP_RING_NUMBER_EN) | (HFP_1T2_CALL_HOLD * BT_HFP_1T2_CALL_HOLD_EN)
#define A2DP_FEATURE        (A2DP_AVRCP_VOL_CTRL*BT_A2DP_VOL_CTRL_EN) | (A2DP_RESTORE_PLAYING*BT_A2DP_SUPTO_RESTORE_PLAY_EN) | (A2DP_AVDTP_DELAY_REPORT*BT_AVDTP_DELAY_REPORT_EN) | (A2DP_AVDTP_DYN_LATENCY * BT_AVDTP_DYN_LATENCY_EN) | (A2DP_AVDTP_EXCEPT_REST_PLAY * BT_A2DP_EXCEPT_RESTORE_PLAY_EN)
#define A2DP_FEATURE1       (BT_A2DP_VOL_CTRL_WITHOUT_KEY*A2DP_AVRCP_RESET_VOL_CTRL) | (BT_2ACL_FORCE_SWITCH*A2DP_AVDTP_1T2_FORCE_SWITCH)|(BT_A2DP_RECORD_DEVICE_VOL*A2DP_AVRCP_1T2_RECORD_DEVICE_VOL)
#define BT_2ACL_FEATURE     (BT_2ACL_PAIR_ONLY_ODEV * BT_2ACL_PAIR_ODEV)
...
uint8_t cfg_bt_2acl_feature         = BT_2ACL_FEATURE;
...
uint8_t cfg_bt_tws_not_auto_connect = 0;

//uint8_t cfg_bt_sniff_clk_sel        = 3; //休眠省晶振

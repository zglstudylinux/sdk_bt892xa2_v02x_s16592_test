...
config(CHECK, "充满电自动关机", "电池充满自动关机功能，主要用于放入电池仓充电的选项", CH_FULL_AUTO_PWRDWN_EN, 0, CHARGE_EN);
config(CHECK, "充电仓功能", "是否使能充电仓功能", CHBOX_EN, 0, CHARGE_EN);
config(LISTVAL, "充电仓类型选择", "选择正确类型充电仓，确保充满关机和拿起开机功能正常", CH_BOX_TYPE_SEL, BIT, 2, 3, 4, ("兼容5V短暂掉0V后维持电压", 0), ("5V不掉电的充电仓", 1), ("5V掉电但有维持电压", 2), ("5V完全掉电无维持电压", 3), CHBOX_EN);
config(LISTVAL, "仓允许最低维持电压", "inbox信号电压，即充满维持电压的充电仓允许的最低维持电压", CH_INBOX_SEL, BIT, 1, 0, 2, ("1.1V", 0), ("1.7V", 1), CHBOX_EN);
config(CHECK, "从充电仓拿出自动开机", "耳机从充电仓拿出自动开机，注意充满后电池仓自动断电的不能开此选项", CH_OUT_AUTO_PWRON_EN, 0, CHBOX_EN);
...
config(TEXT, "蓝牙名称", "手机上可以看到的蓝牙名称", BT_NAME, 32, "Bluetrum-SPK");
...
config(CHECK, "连接两部手机功能", "是否支持连接两部手机功能（打开<TWS功能>后无效）", BT_2ACL_EN, 1);
...
config(CHECK, "按键HID连接/断开功能", "是否支持蓝牙HID服务，按键手动连接/断开", BT_HID_MANU_EN, 1, BT_HID_EN);
...
config(BIT, "预置MIX_CAP", "设置预置RF参数的MIX_CAP，用于调平TX功率", BT_RF_MIX_CAP, 4, 7, 9, 8);
...
config(LEVEL, 0x03);
config(LISTVAL, "降低回连功率", "是否降低回连手机或TWS的功率", BT_RF_PAGE_PWRDEC, BIT, 3, 0, 4, ("不降低", 0), ("降低3dbm", 1), ("降低6dbm", 2), ("降低9dbm", 3));
...
config(LISTVAL, "MICL通路选择", "选择MICL通路", MICL_SEL, BIT, 3, 1, 5, ("MICNL_PF4", 0), ("MICPL_PF5", 1), ("MICL_VUSB", 2), ("MICNR_PF2", 4), ("MICPR_PF3", 5), MICL_EN);
...
config(LISTVAL, "MICR通路选择", "选择MICR通路", MICR_SEL, BIT, 3, 5, 5, ("MICNL_PF4", 0), ("MICPL_PF5", 1), ("MICNR_PF2", 4), ("MICPR_PF3", 5), ("MICR_VUSB", 6)MICR_EN);
...
config(LEVEL, 0x00);
config(LISTVAL, "MIC插入检测配置", "选择MIC检测GPIO，或Disable MIC检测", MIC_DET_IOSEL, BIT, 6, 0, 24, ("None", 0), ("PA3", 4), ("PA4", 5), ("PA5", 6), ("PA6", 7), ("PA7", 8), ("PB0", 9), ("PB1", 10), ("PB2", 11), ("PB3", 12), ("PB4", 13), ("PB5/WKO", 26), ("PE0", 14), ("PE4", 18), ("PE5", 19), ("PE6", 20), ("PE7", 21), ("PF0", 22), ("PF1", 23), ("PF2", 24), ("PF3", 25), ("复用SDCLK检测", 27), ("复用SDCMD检测", 28), ("复用PWRKEY检测", 29));
config(LEVEL, 0x03);
...
config(BYTE, "风噪降噪量", "抑制风噪的降噪量（0~58dB 步进2dB）", BT_SNDP_DM_WIND_LEVEL, 0, 29, 6, BT_SNDP_DM_EN);
...
config(NUM, "响应限幅", "最大冲击响应限幅，声加工具会给一个参考值，也是最大值，越大收敛越快，超过参考值会导致间断失音，默认97150", BT_SNDP_DM_MAXIR, 0, 262144, 97150, BT_SNDP_DM_EN);
config(CHECK, "声加双麦+AI降噪", "config.h 打开 BT_SNDP_DMIC_DNN_EN 宏，注: 双麦间距在config.h配置", BT_SNDP_DMDNN_EN, 0, BT_SCO_EN);
config(BYTE, "拾音角度(单位:°)", "通话的拾音角度，与双麦之间的连线左右两边形成的夹角，单位是角度值，如果耳机佩戴位置变化大，建议加大角度", BT_SNDP_DMDNN_DEGREE, 10, 89, 30, BT_SNDP_DMDNN_EN);
config(BYTE, "最大保护角(单位:°)", "单位是角度值，默认89度；在调节拾音角度bf效果无法改善情况下可以调小此角度，但一定大于等于拾音角度", BT_SNDP_DMDNN_MAX_DEGREE, 10, 89, 89, BT_SNDP_DMDNN_EN);
config(BYTE, "通话降噪量", "传统后处理降噪量（0~58dB 步进2dB）", BT_SNDP_DMDNN_LEVEL, 0, 29, 5, BT_SNDP_DMDNN_EN);
config(BYTE, "DNN最大降噪量", "DNN最大降噪量（0~58dB 步进2dB）", BT_SNDP_DMDNN_DNN_LEVEL, 0, 29, 13, BT_SNDP_DMDNN_EN);
config(BYTE, "风噪降噪量", "抑制风噪的降噪量（0~58dB 步进2dB）", BT_SNDP_DMDNN_WIND_LEVEL, 0, 29, 3, BT_SNDP_DMDNN_EN);
config(BYTE, "固定波束频率上限", "固定波束频率上限（128对应4000Hz）", BT_SNDP_DMDNN_BF_UPPER, 0, 255, 128, BT_SNDP_DMDNN_EN);
config(CHECK, "DMNS双麦降噪", "config.h打开BT_SCO_DMNS_EN或者BT_SCO_DMDNN_EN", BT_DMNS_EN, 0, BT_SCO_EN);
config(BYTE, "双麦间距", "出音孔之间的直线距离（20~40mm）", BT_DMNS_DISTANCE, 15, 40, 23, BT_DMNS_EN);
config(NUM, "拾音方向", "默认为0，通话的拾音方向，不建议修改", BT_DMNS_DEGREE, 0, 360, 0, BT_DMNS_EN);
config(BYTE, "通话降噪量", "参考值为0，值越大平稳噪声越少", BT_DMNS_LEVEL, 0, 20, 0, BT_DMNS_EN);
config(BYTE, "BF抑制量", "beamforming抑制量,根据不同耳机设置，默认5", BT_DMNS_BF_LEVEL, 0, 20, 5, BT_DMNS_EN);
config(BYTE, "喇叭声抑制量", "喇叭声抑制量，默认10", BT_TRUMPET_LEVEL, 0, 15, 10, BT_SCO_EN);
...
config(BYTE, "AEC远端补偿值", "远端补偿值(0~255)", BT_FAR_OFFSET, 0, 255, 240, BT_AEC_EN);
config(BIT, "AEC数字增益", "AEC频域数字增益(0~15DB), Step 1DB，BT_NLMS_FRE_EN置1有效", AEC_DIG_GAIN, 4, 0, 15, 0, BT_AEC_EN);
...
config(LISTVAL, "SDCARD检测IO选择", "选择SDCARD检测GPIO", SDDET_IOSEL, BIT, 6, 23, 25, ("None", 0), ("PA3", 4), ("PA4", 5), ("PA5", 6), ("PA6", 7), ("PA7", 8), ("PB0", 9), ("PB1", 10), ("PB2", 11), ("PB3", 12), ("PB4", 13), ("PB5/WKO", 26), ("PE0", 14), ("PE4", 18), ("PE5", 19), ("PE6", 20), ("PE7", 21), ("PF0", 22), ("PF1", 23), ("PF2", 24), ("PF3", 25), ("复用SDCLK检测", 27), ("复用SDCMD检测", 28), ("复用PWRKEY检测", 29),("软件检测", 30), MUSIC_SDCARD_EN);
...
config(LISTVAL, "AUXL通路选择", "AUX左声道通路选择", AUXL_SEL, BIT, 4, 0, 8, ("无AUXL输入", 0), ("AUXL_PA6", 1), ("AUXL_PB1", 2), ("AUXL_PE6", 3), ("AUXL_PF1", 4), ("AUXL_VCMBUF", 5), ("AUXL_MIC", 6), ("AUXL_VOUTRP", 7), FUNC_AUX_EN);
config(LISTVAL, "AUXR通路选择", "AUX右声道通路选择", AUXR_SEL, BIT, 4, 0, 8, ("无AUXR输入", 0), ("AUXR_PA7", 1), ("AUXR_PB2", 2), ("AUXR_PE7", 3), ("AUXR_PF2", 4), ("AUXR_VCMBUF", 5), ("AUXR_MIC", 6), ("AUXR_VOUTRN", 7), FUNC_AUX_EN);
...
config(LISTVAL, "ADKEY1通路选择", "第一组ADKEY io mapping select", ADKEY_CH,   BIT, 4, 9, 11, ("ADCCH_PA5", 0), ("ADCCH_PA6", 1), ("ADCCH_PA7", 2), ("ADCCH_PB1", 3), ("ADCCH_PB2", 4), ("ADCCH_PB3", 5), ("ADCCH_PB4", 6), ("ADCCH_PE5", 7), ("ADCCH_PE6", 8), ("ADCCH_PE7", 9), ("ADCCH_PF2", 10), USER_ADKEY_EN);
config(LISTVAL, "ADKEY2通路选择", "第二组ADKEY io mapping select", ADKEY2_CH,  BIT, 4, 9, 11, ("ADCCH_PA5", 0), ("ADCCH_PA6", 1), ("ADCCH_PA7", 2), ("ADCCH_PB1", 3), ("ADCCH_PB2", 4), ("ADCCH_PB3", 5), ("ADCCH_PB4", 6), ("ADCCH_PE5", 7), ("ADCCH_PE6", 8), ("ADCCH_PE7", 9), ("ADCCH_PF2", 10), USER_ADKEY2_EN);
...
config(LISTVAL, "USER_DEF键长按", "选择USER_DEF键长按的功能", USER_DEF_KL_SEL,    BIT, 4, 2, 13, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12));
config(LISTVAL, "USER_DEF键双击", "选择USER_DEF键双击的功能", USER_DEF_KD_SEL,    BIT, 4, 1, 13, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12));
config(LISTVAL, "USER_DEF键三击", "选择USER_DEF键三击的功能", USER_DEF_KT_SEL, 	  BIT, 4, 0, 13, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12));
config(LISTVAL, "USER_DEF键四击", "选择USER_DEF键四击的功能", USER_DEF_KFOUR_SEL, BIT, 4, 0, 13, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12));
config(LISTVAL, "USER_DEF键五击", "选择USER_DEF键五击的功能", USER_DEF_KFIVE_SEL, BIT, 4, 0, 13, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12));
...
config(LISTVAL, "PWRKEY按键1功能", "PWRKEY第1个按键功能定制", PWRKEY_NUM0, BYTE, 20, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), PWRKEY_CONFIG_EN);
config(LISTVAL, "PWRKEY按键2功能", "PWRKEY第2个按键功能定制", PWRKEY_NUM1, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22),  PWRKEY_CONFIG_EN);
config(LISTVAL, "PWRKEY按键3功能", "PWRKEY第3个按键功能定制", PWRKEY_NUM2, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22),  PWRKEY_CONFIG_EN);
config(LISTVAL, "PWRKEY按键4功能", "PWRKEY第4个按键功能定制", PWRKEY_NUM3, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22),  PWRKEY_CONFIG_EN);
config(LISTVAL, "PWRKEY按键5功能", "PWRKEY第5个按键功能定制", PWRKEY_NUM4, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22),  PWRKEY_CONFIG_EN);

config(CHECK, "ADKEY1按键定制", "是否配置第一组ADKEY按键功能，不勾选使用SDK默认按键配置", ADKEY_CONFIG_EN, 0);
config(LISTVAL, "ADKEY1按键1功能", "ADKEY1第1个按键功能定制", ADKEY1_NUM0, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键2功能", "ADKEY1第2个按键功能定制", ADKEY1_NUM1, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键3功能", "ADKEY1第3个按键功能定制", ADKEY1_NUM2, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键4功能", "ADKEY1第4个按键功能定制", ADKEY1_NUM3, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键5功能", "ADKEY1第5个按键功能定制", ADKEY1_NUM4, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键6功能", "ADKEY1第6个按键功能定制", ADKEY1_NUM5, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键7功能", "ADKEY1第7个按键功能定制", ADKEY1_NUM6, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键8功能", "ADKEY1第8个按键功能定制", ADKEY1_NUM7, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键9功能", "ADKEY1第9个按键功能定制", ADKEY1_NUM8, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键10功能", "ADKEY1第10个按键功能定制", ADKEY1_NUM9, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键11功能", "ADKEY1第11个按键功能定制", ADKEY1_NUM10, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
config(LISTVAL, "ADKEY1按键12功能", "ADKEY1第12个按键功能定制", ADKEY1_NUM11, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), ADKEY_CONFIG_EN);
...
config(LISTVAL, "IOKEY按键1功能", "IOKEY第1个按键功能定制", IOKEY_NUM0, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), IOKEY_CONFIG_EN);
config(LISTVAL, "IOKEY按键2功能", "IOKEY第2个按键功能定制", IOKEY_NUM1, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), IOKEY_CONFIG_EN);
config(LISTVAL, "IOKEY按键3功能", "IOKEY第3个按键功能定制", IOKEY_NUM2, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), IOKEY_CONFIG_EN);
config(LISTVAL, "IOKEY按键4功能", "IOKEY第4个按键功能定制", IOKEY_NUM3, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), IOKEY_CONFIG_EN);
config(LISTVAL, "IOKEY按键5功能", "IOKEY第5个按键功能定制", IOKEY_NUM4, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), IOKEY_CONFIG_EN);
config(LISTVAL, "两IO中间的按键功能", "IOKEY1与IOKEY2两IO中间的按键", IOKEY_MIDKEY_NUM, BYTE, 0, 23, ("None", 0), ("P/P", 1), ("PWR", 2), ("NEXT/VOL+", 3), ("PREV/VOL-", 4), ("NEXT/VOL-", 5), ("PREV/VOL+", 6), ("VOL+/NEXT", 7), ("VOL-/PREV", 8), ("VOL-/NEXT", 9), ("VOL+/PREV", 10), ("VOL+", 11), ("VOL-", 12), ("NEXT", 13), ("PREV", 14), ("MODE", 15), ("HSF", 16), ("MODE/PWR", 17), ("SIRI", 18), ("HOME", 19), ("PP/PWR/USER_DEF", 20), ("PP/USER_DEF", 21), ("VOL+/VOL-", 22), IOKEY_CONFIG_EN);
...
config(BYTE, "自定义OSCI电容", "独立配置26M晶振OSCI负载电容，单位0.25PF。OSCI电容大小：n * 0.25PF + 基础电容", UOSCI_CAP, 0, 63, 40, USER_CAP);
config(BYTE, "自定义OSCO电容", "独立配置26M晶振OSCO负载电容，单位0.25PF。OSCO电容大小：n * 0.25PF + 基础电容", UOSCO_CAP, 0, 63, 40, USER_CAP);
config(LEVEL, 0x0E);
config(KEEP);
config(BYTE, "产测OSCI电容", "独立配置26M晶振OSCI负载电容，单位0.25PF。OSCI电容大小：n * 0.25PF + 基础电容", OSCI_CAP, 0, 63, 40);
config(BYTE, "产测OSCO电容", "独立配置26M晶振OSCO负载电容，单位0.25PF。OSCO电容大小：n * 0.25PF + 基础电容", OSCO_CAP, 0, 63, 40);

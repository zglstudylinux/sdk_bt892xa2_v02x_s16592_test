...
typedef struct __attribute__((packed)) _xcfg_cb_t {
    ...
    u32 micl_sel                         : 3;   //MICL通路选择: MICNL_PF4: 0, MICPL_PF5: 1, MICL_VUSB: 2, MICNR_PF2: 4, MICPR_PF3: 5
    ...
    u32 micr_sel                         : 3;   //MICR通路选择: MICNL_PF4: 0, MICPL_PF5: 1, MICNR_PF2: 4, MICPR_PF3: 5, MICR_VUSB: 6
    ...
    u32 mic_det_iosel                    : 6;   //MIC插入检测配置: None: 0, PA3: 4, PA4: 5, PA5: 6, PA6: 7, PA7: 8, PB0: 9, PB1: 10, PB2: 11, PB3: 12, PB4: 13, PB5/WKO: 26, PE0: 14, PE4: 18, PE5: 19, PE6: 20, PE7: 21, PF0: 22, PF1: 23, PF2: 24, PF3: 25, 复用SDCLK检测: 27, 复用SDCMD检测: 28, 复用PWRKEY检测: 29
    u32 anc_en                           : 1;   //ANC功能
    ...
    u32 bt_sndp_dmdnn_en                 : 1;   //声加双麦+AI降噪
    u8 bt_sndp_dmdnn_degree;                    //拾音角度(单位:°)
    u8 bt_sndp_dmdnn_max_degree;                //最大保护角(单位:°)
    u8 bt_sndp_dmdnn_level;                     //通话降噪量
    u8 bt_sndp_dmdnn_dnn_level;                 //DNN最大降噪量
    u8 bt_sndp_dmdnn_wind_level;                //风噪降噪量
    u8 bt_sndp_dmdnn_bf_upper;                  //固定波束频率上限
    u32 bt_dmns_en                       : 1;   //DMNS双麦降噪
    u8 bt_dmns_distance;                        //双麦间距
    u32 bt_dmns_degree;                         //拾音方向
    u8 bt_dmns_level;                           //通话降噪量
    u8 bt_dmns_bf_level;                        //BF抑制量
    u8 bt_trumpet_level;                        //喇叭声抑制量
    u32 bt_aec_en                        : 1;   //AEC功能
    u8 bt_echo_level;                           //AEC回声消除级别
    u8 bt_far_offset;                           //AEC远端补偿值
    u32 aec_dig_gain                     : 4;   //AEC数字增益
    ...
    u32 sddet_iosel                      : 6;   //SDCARD检测IO选择: None: 0, PA3: 4, PA4: 5, PA5: 6, PA6: 7, PA7: 8, PB0: 9, PB1: 10, PB2: 11, PB3: 12, PB4: 13, PB5/WKO: 26, PE0: 14, PE4: 18, PE5: 19, PE6: 20, PE7: 21, PF0: 22, PF1: 23, PF2: 24, PF3: 25, 复用SDCLK检测: 27, 复用SDCMD检测: 28, 复用PWRKEY检测: 29, 软件检测: 30
    ...
    u32 auxl_sel                         : 4;   //AUXL通路选择: 无AUXL输入: 0, AUXL_PA6: 1, AUXL_PB1: 2, AUXL_PE6: 3, AUXL_PF1: 4, AUXL_VCMBUF: 5, AUXL_MIC: 6, AUXL_VOUTRP: 7
    u32 auxr_sel                         : 4;   //AUXR通路选择: 无AUXR输入: 0, AUXR_PA7: 1, AUXR_PB2: 2, AUXR_PE7: 3, AUXR_PF2: 4, AUXR_VCMBUF: 5, AUXR_MIC: 6, AUXR_VOUTRN: 7
    ...
    u32 adkey_ch                         : 4;   //ADKEY1通路选择: ADCCH_PA5: 0, ADCCH_PA6: 1, ADCCH_PA7: 2, ADCCH_PB1: 3, ADCCH_PB2: 4, ADCCH_PB3: 5, ADCCH_PB4: 6, ADCCH_PE5: 7, ADCCH_PE6: 8, ADCCH_PE7: 9, ADCCH_PF2: 10
    u32 adkey2_ch                        : 4;   //ADKEY2通路选择: ADCCH_PA5: 0, ADCCH_PA6: 1, ADCCH_PA7: 2, ADCCH_PB1: 3, ADCCH_PB2: 4, ADCCH_PB3: 5, ADCCH_PB4: 6, ADCCH_PE5: 7, ADCCH_PE6: 8, ADCCH_PE7: 9, ADCCH_PF2: 10
    ...
    u32 user_def_kl_sel                  : 4;   //USER_DEF键长按: 无: 0, 回拨: 1, SIRI: 2, PREV: 3, NEXT: 4, VOL+: 5, VOL-: 6, MODE: 7, HID拍照: 8, IOS HOME: 9, 中英文切换: 10, PLAY/PAUSE: 11, CBT_TEST: 12
    u32 user_def_kd_sel                  : 4;   //USER_DEF键双击: 无: 0, 回拨: 1, SIRI: 2, PREV: 3, NEXT: 4, VOL+: 5, VOL-: 6, MODE: 7, HID拍照: 8, IOS HOME: 9, 中英文切换: 10, PLAY/PAUSE: 11, CBT_TEST: 12
    u32 user_def_kt_sel                  : 4;   //USER_DEF键三击: 无: 0, 回拨: 1, SIRI: 2, PREV: 3, NEXT: 4, VOL+: 5, VOL-: 6, MODE: 7, HID拍照: 8, IOS HOME: 9, 中英文切换: 10, PLAY/PAUSE: 11, CBT_TEST: 12
    u32 user_def_kfour_sel               : 4;   //USER_DEF键四击: 无: 0, 回拨: 1, SIRI: 2, PREV: 3, NEXT: 4, VOL+: 5, VOL-: 6, MODE: 7, HID拍照: 8, IOS HOME: 9, 中英文切换: 10, PLAY/PAUSE: 11, CBT_TEST: 12
    u32 user_def_kfive_sel               : 4;   //USER_DEF键五击: 无: 0, 回拨: 1, SIRI: 2, PREV: 3, NEXT: 4, VOL+: 5, VOL-: 6, MODE: 7, HID拍照: 8, IOS HOME: 9, 中英文切换: 10, PLAY/PAUSE: 11, CBT_TEST: 12
    ...
    u8 pwrkey_num0;                             //PWRKEY按键1功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 pwrkey_num1;                             //PWRKEY按键2功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 pwrkey_num2;                             //PWRKEY按键3功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 pwrkey_num3;                             //PWRKEY按键4功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 pwrkey_num4;                             //PWRKEY按键5功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u32 adkey_config_en                  : 1;   //ADKEY1按键定制
    u8 adkey1_num0;                             //ADKEY1按键1功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num1;                             //ADKEY1按键2功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num2;                             //ADKEY1按键3功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num3;                             //ADKEY1按键4功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num4;                             //ADKEY1按键5功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num5;                             //ADKEY1按键6功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num6;                             //ADKEY1按键7功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num7;                             //ADKEY1按键8功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num8;                             //ADKEY1按键9功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num9;                             //ADKEY1按键10功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num10;                            //ADKEY1按键11功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 adkey1_num11;                            //ADKEY1按键12功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    ...
    u8 iokey_num0;                              //IOKEY按键1功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 iokey_num1;                              //IOKEY按键2功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 iokey_num2;                              //IOKEY按键3功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 iokey_num3;                              //IOKEY按键4功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 iokey_num4;                              //IOKEY按键5功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22
    u8 iokey_midkey_num;                        //两IO中间的按键功能: None: 0, P/P: 1, PWR: 2, NEXT/VOL+: 3, PREV/VOL-: 4, NEXT/VOL-: 5, PREV/VOL+: 6, VOL+/NEXT: 7, VOL-/PREV: 8, VOL-/NEXT: 9, VOL+/PREV: 10, VOL+: 11, VOL-: 12, NEXT: 13, PREV: 14, MODE: 15, HSF: 16, MODE/PWR: 17, SIRI: 18, HOME: 19, PP/PWR/USER_DEF: 20, PP/USER_DEF: 21, VOL+/VOL-: 22

...
void bt_sco_dump_init(u8 *sysclk, bt_voice_cfg_t *p);
    ...
    #define bt_sco_ns_process(a)            bt_ains3_plus_process(a)
    ...
    #define bt_sco_ns_process(a)            bt_ldmdnn_plus_process(a)
#elif BT_SNDP_DMIC_EN || BT_SNDP_DMIC_DNN_EN
    ...
    #define bt_sco_ns_process(a)            bt_dnn_process(a)
#elif BT_SCO_AIAEC_DNN_EN
    #define bt_sco_near_nr_init(a, b)       bt_sco_aiaec_dnn_init(a, b)
    #define bt_sco_ns_process(a)            bt_aiaec_dnn_process(a)
#else

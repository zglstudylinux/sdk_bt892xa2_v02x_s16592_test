...
#define RES_BUF_POWERON_MP3             RES_BUF_ZH_POWERON_MP3
#define RES_LEN_POWERON_MP3             RES_LEN_ZH_POWERON_MP3
...
#define RES_BUF_CALL_HANGUP_MP3         RES_BUF_ZH_CALL_HANGUP_MP3
#define RES_LEN_CALL_HANGUP_MP3         RES_LEN_ZH_CALL_HANGUP_MP3
#define RES_BUF_CALL_REJECT_MP3         RES_BUF_ZH_CALL_REJECT_MP3
#define RES_LEN_CALL_REJECT_MP3         RES_LEN_ZH_CALL_REJECT_MP3
#define RES_BUF_REDIALING_MP3           RES_BUF_ZH_REDIALING_MP3
#define RES_LEN_REDIALING_MP3           RES_LEN_ZH_REDIALING_MP3
...
#define RES_BUF_MUSIC_MODE_MP3          RES_BUF_ZH_MUSIC_MODE_MP3
#define RES_LEN_MUSIC_MODE_MP3          RES_LEN_ZH_MUSIC_MODE_MP3
#define RES_BUF_GAME_MODE_MP3           RES_BUF_ZH_GAME_MODE_MP3
#define RES_LEN_GAME_MODE_MP3           RES_LEN_ZH_GAME_MODE_MP3

#elif (LANG_SELECT == LANG_EN)
#define MUTIL_LANG_TBL_EN               0
#define RES_BUF_POWERON_MP3             RES_BUF_EN_POWERON_MP3
#define RES_LEN_POWERON_MP3             RES_LEN_EN_POWERON_MP3
...
#define RES_BUF_CALL_HANGUP_MP3         RES_BUF_EN_CALL_HANGUP_MP3
#define RES_LEN_CALL_HANGUP_MP3         RES_LEN_EN_CALL_HANGUP_MP3
#define RES_BUF_CALL_REJECT_MP3         RES_BUF_EN_CALL_REJECT_MP3
#define RES_LEN_CALL_REJECT_MP3         RES_LEN_EN_CALL_REJECT_MP3
#define RES_BUF_REDIALING_MP3           RES_BUF_EN_REDIALING_MP3
#define RES_LEN_REDIALING_MP3           RES_LEN_EN_REDIALING_MP3
...
#define RES_BUF_MUSIC_MODE_MP3          RES_BUF_EN_MUSIC_MODE_MP3
#define RES_LEN_MUSIC_MODE_MP3          RES_LEN_EN_MUSIC_MODE_MP3
#define RES_BUF_GAME_MODE_MP3           RES_BUF_EN_GAME_MODE_MP3
#define RES_LEN_GAME_MODE_MP3           RES_LEN_EN_GAME_MODE_MP3
